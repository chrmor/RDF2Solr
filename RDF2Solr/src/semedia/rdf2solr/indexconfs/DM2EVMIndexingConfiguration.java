...
public class DM2EVMIndexingConfiguration extends Configuration {

	/**
	 * DM2E configuration
	 */
	//private static final String DM2E_SOLR_SERVER = "http://metasound.dibet.univpm.it:8080/solr-dm2e/";
	private static final String DM2E_SOLR_SERVER = "http://localhost:8080/solr/";
...
//		+ ")";
	//GEI Only
	private static final String namedGraphsFilter = "FILTER ("
			+ "?g = <http://localhost:8080/data/dataset/gei/gei-digital/20141106011143643>"
		+ ")";
	//WAB only
//	private static final String namedGraphsFilter = "FILTER ("
//			+ "?g = <http://data.dm2e.eu/data/dataset/uib/wab/20140829133247065>"
